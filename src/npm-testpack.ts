...
export function testPack(opts: Options): SpawnSyncReturns<Buffer>
{
  ...
  if (!pkg.files || !Array.isArray(pkg.files)) {
    ...
    throw `A "files" section is needed to ensure that files generated by testpack are not added accidentally to your package.`;
  }
...
export function runNpmPack(pkg: PackageJson, opts: Options): string {
  ...
  if (!fs.existsSync(pkgName))
    throw `Expected ${pkgName} to exist but it doesn't.`;
  return pkgName;
}
